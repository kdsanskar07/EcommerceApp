...
class SetLocationChange extends StatefulWidget {
  UserInfo userInfo;
  SetLocationChange({this.userInfo});
  @override
  _SetLocationChangeState createState() => _SetLocationChangeState();
}

class _SetLocationChangeState extends State<SetLocationChange> {
      ...
      bottomNavigationBar: InkWell(
          onTap: () {
            ...
            if(_textCity.text.isEmpty==false&&_textBuildingNumber.text.isEmpty==false&&_textStreetName.text.isEmpty==false&&_textLocality.text.isEmpty==false&&_textPinCode.text.length==6){
              widget.userInfo.city = _textCity.text;
              widget.userInfo.streetName = _textStreetName.text;
              widget.userInfo.locality = _textLocality.text;
              widget.userInfo.buildingNumber = _textBuildingNumber.text;
              widget.userInfo.pinCode = _textPinCode.text;
          ...
          child: Container(
            margin: EdgeInsets.fromLTRB(
                _width * 0.04, 0, _width * 0.04, _height*0.01),
            height: _height * 0.07,
