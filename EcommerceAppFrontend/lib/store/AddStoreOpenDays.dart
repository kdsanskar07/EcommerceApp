...
class AddStoreOpenDays extends StatefulWidget {
  UserInfo userInfo;
  StoreInfo storeInfo;
  AddStoreOpenDays({this.storeInfo,this.userInfo});
  @override
  _AddStoreOpenDaysState createState() => _AddStoreOpenDaysState();
}

class _AddStoreOpenDaysState extends State<AddStoreOpenDays> {
      ...
      bottomNavigationBar: InkWell(
        onTap: (){
          ...
          if(!_storeClosesAt.text.isEmpty && !_storeOpensAt.text.isEmpty){
            ...
            Navigator.push(
                context, CupertinoPageRoute(builder: (context) => NewCategory(storeInfo: widget.storeInfo,userInfo: widget.userInfo))
            );
          }
        },
        child: Container(
